...
namespace SpaceDefence
{
	public class GameManager
	{
		...
		{
			GameObject[] allNonShips = _gameObjects.FindAll(go => !(go is Ship)).ToArray();
			GameObject[] allShips = _gameObjects.FindAll(go => go is Ship).ToArray();
			...
			foreach (GameObject gameObject in allNonShips)
			{
