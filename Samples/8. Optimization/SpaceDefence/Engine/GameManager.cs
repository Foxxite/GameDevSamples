...
namespace SpaceDefence
{
    public class GameManager
    {
        ...
        // basically within one clump cell (150 px).  
        // Raise this to save more CPU, lower it if ships feel like they stop reacting to formation changes.
                                       ...
                                       float speed, CollisionType collisionType)
        {
            ...
            {
                // Slot is free: reset and queue for add.
                b.Reset(location, direction, speed, collisionType);
                b.IsActive = true;
                AddGameObject(b);
            }
        ...
        public void HandleInput(InputManager inputManager)
        {
            ...
            // Live-tune the clump grouping cell size with the scroll wheel, for
            // testing/demoing how clump size trades off against per-ship accuracy.
